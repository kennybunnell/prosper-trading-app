...
## Bulk Quantity Controls in Filters Section (Feb 15, 2026)
- [ ] Add bulk quantity controls UI in filters section below Select All/Clear buttons
- [ ] Implement in CSPDashboard:
  - [ ] Add increment/decrement buttons to adjust quantity for all selected opportunities
  - [ ] Add "Set All to 1" button to reset all selected to single contracts
  - [ ] Add "Double All" button to quickly scale up positions
  - [ ] Only affect selected opportunities
  - [ ] Update quantities in state before opening preview modal
- [ ] Implement in CCDashboard with same pattern
- [ ] Implement in Bull Put Spread dashboard (if exists)
- [ ] Implement in Bear Call Spread dashboard (if exists)
- [ ] Controls should work alongside per-order controls in preview modal
- [ ] User needs to test: Select multiple opportunities, adjust quantities in bulk, verify preview modal shows updated quantities

## Bulk Quantity Controls in Filters Section (Feb 15, 2026)
- [x] Add bulk quantity controls UI in filters section (below Select All/Clear buttons)
- [x] Controls include: increment (-) / decrement (+) buttons, "Set All to 1", "Double All"
- [x] Only affects selected opportunities (shows when selectedOpportunities.size > 0)
- [x] Add opportunityQuantities state to track quantities before opening preview modal
- [x] Pass quantities to UnifiedOrderPreviewModal when opening (via order.quantity field)
- [x] Implemented in CSPDashboard (CSP and Bull Put Spread)
- [x] Implemented in CCDashboard (Covered Call and Bear Call Spread)
- [x] Show total quantity count across all selected opportunities
- [x] Toast notifications for all bulk quantity actions
- [ ] User needs to test: Select multiple opportunities, use bulk quantity controls, verify quantities persist in preview modal
